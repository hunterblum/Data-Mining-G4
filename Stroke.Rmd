...
CART_bal_crt <- caret::train(stroke ~ . , method = "rpart", data = Stroke_over, tuneLength = 5, 
                       trControl = trainControl(
                         method = "cv", indexOut = train
                       ))

rpart.plot(CART_bal_crt$finalModel)

cart_bal_car <- confusionMatrix(data = predict(CART_bal_crt, Stroke_test), ref = Stroke_test$stroke, positive = "Yes")
```
...
Model_comp <- rbind(`ANN Reg.`, `ANN Bal.`, `ANN Z`, `ANN Z Bal.`, `RF Reg.`, `RF Bal.`, `CART Bal.`, `CART Bal. Car`, `C5.0 Bal.`, `NB Gender`, `NB Heart + Marry`, `NB Resident`, `NB Smoke + Work`)
