...
colnames(gen) <- c("stroke = 1", "stroke = 0")
rownames(gen) <- c("gender = Male", "gender = Female")
...
colnames(gen) <- c("stroke = 1", "stroke = 0")
rownames(gen) <- c("hypertension = 1", "hyptertension = 0")
...
colnames(gen) <- c("stroke = 1", "stroke = 0")
rownames(gen) <- c("heart_disease = 1", "heart_disease = 0")
...
colnames(gen) <- c("stroke = 1", "stroke = 0")
rownames(gen) <- c("ever_married = Yes", "ever_married = No")
...
colnames(gen) <- c("stroke = 1", "stroke = 0")
rownames(gen) <- c("Residence_type = Urban", "Residence_type = Rural")
