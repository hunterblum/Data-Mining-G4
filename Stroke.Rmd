...
```{r}
#x is saved confusion matrix
#Attempt at making this more streamline

# Accuracy_models <- function(x) {
#   model <- x
#   model[["overall"]][["Accuracy"]]
# }
# 
# Accuracy_models(nnet_reg)
# Accuracy_list <- Map(c, nnet_bal, nnet_reg)
# Accuracy <- sapply(X = Accuracy_list, FUN = Accuracy_models)
